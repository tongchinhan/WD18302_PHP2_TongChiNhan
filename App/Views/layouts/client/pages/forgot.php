        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="App/Views/layouts/images/email2.jpg" alt="IMG">
              </div>
                <div class="login100-form validate-form">
                    <span class="login100-form-title">
                        <b>KHÔI PHỤC MẬT KHẨU</b>
                    </span>
                    <form action="?url=FogotpassController/resetPassword" method="post">
                    ...
                    <div class="text-center p-t-70 txt2">
                        ...
                        <script type="text/javascript">document.write(new Date().getFullYear());</script> <a
                            class="txt2" href="https://www.facebook.com/profile.php?id=100081867357565"> Code bởi Nhân Tống </a>
                    </div>
                </div>
            </div>
        </div>
