...
<body>
    <div class="limiter">
        <div class="container-login100">
            ...
            <form class="login100-form validate-form" action="?url=FogotpassController/handleResetPassword" method="post">
                    ...
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="password" placeholder="Mật Khẩu Mới" name="passwordmoi" id="passwordmoi">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
