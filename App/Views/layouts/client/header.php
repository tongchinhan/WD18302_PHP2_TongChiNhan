  ...
  <header class="app-header">
        ...
        <ul class="app-nav">
                ...
                <!-- User Menu-->
                <li><a class="app-nav__item" href="?url=LoginController"><i class='bx bx-log-out bx-rotate-180'></i> </a>
...
<aside class="app-sidebar">
        <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="App/Views/layouts/images/tuidaubon.jpg" width="50px" alt="User Image">
                <div>
        ...
        <ul class="app-menu">
                ...
                <li><a class="app-menu__item " href="?url=TaiLieuController/TaiLieuControllerpage"><i class='app-menu__icon bx bx-id-card'></i> <span class="app-menu__label">Danh Sách Tài Liệu</span></a></li>
