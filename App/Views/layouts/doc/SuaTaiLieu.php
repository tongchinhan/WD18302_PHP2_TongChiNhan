<body onload="time()" class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <h3 class="tile-title">Sửa mới tài liệu</h3>
                    <div class="tile-body">
                        <form class="row" method="post" action="?url=TaiLieuController/updateTaiLieu&id=<?php echo $_GET['id'] ?>" enctype="multipart/form-data">
